...
var Finish ={
	...
	update: function(){},
	wallPost: function(){
		VK.api("wall.post", {"message": String("В игре Udareniya я заработал "+score+this.whatSl()+"                           Играть через пк: http://qoo.by/47B3   Через телефон: http://qoo.by/47B2"), "attachments": "photo-160039023_456239019"});
	},
	whatSl: function(){
		var ret="очко";
