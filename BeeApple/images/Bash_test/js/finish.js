...
var Finish ={
	preload : function(){},
	create: function(){
		var retryBut = game.add.text(220,300,"зАново",{font:"bold 24px Arial",fill:'#000000', align:'center'});
		var postBut = game.add.text(410,300,"опубликовАть",{font:"bold 24px Arial",fill:'#000000', align:'center'});
		graphics=game.add.graphics(0,0);
		graphics.lineStyle(0);
		graphics.beginFill(0x4869D6,0.5);
		graphics.drawRect(retryBut.x-30,retryBut.y-5,retryBut.width+60,retryBut.height+10);
		graphics.drawRect(postBut.x-30,postBut.y-5,postBut.width+60,postBut.height+10);
		graphics.endFill();
		instruction = game.add.text(game.world.width/2,230,
			"Вы заработали\n "+score+this.whatSl(),
			{font:"bold 28px Arial",fill:'#000000', align:'center'});
		instruction.anchor.set(0.5,0.5);	
		scoresText = game.add.text(5,5,"",{font:"italic 28px Arial",fill:'#1c3956'});
	...
	update: function(){},
	wallPost: function(){
		//VK.api("wall.post", {"message": String("В игре Udareniya я заработал "+score+this.whatSl()+"             Ссылка: vk.com/app6393619"), "attachments": "photo-160039023_456239018"});
	},
	whatSl: function(){
		var ret="очко";
		if(score==0 || score>=5){
